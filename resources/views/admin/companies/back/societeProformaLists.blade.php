    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-societeProformaLists">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.proformaList.fields.societe') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-societeProformaLists:not(.ajaxTable)').DataTable({ buttons: dtButtons })
