        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <form action="{{ route('admin.banks.create') }}" method="GET">
                    <input type="text" name="company_id" id="" value="{{ $company->id }}" hidden>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-companyBanks">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-companyBanks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
