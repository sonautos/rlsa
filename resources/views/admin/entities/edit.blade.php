    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.entities.update", [$entity->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alias') ? 'is-invalid' : '' }}" type="text" name="alias" id="alias" value="{{ old('alias', $entity->alias) }}">
                @if($errors->has('alias'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('supplier') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="supplier" id="supplier" value="1" {{ $entity->supplier || old('supplier', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $entity->status) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent') ? 'is-invalid' : '' }}" type="number" name="parent" id="parent" value="{{ old('parent', $entity->parent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_client') ? 'is-invalid' : '' }}" type="text" name="code_client" id="code_client" value="{{ old('code_client', $entity->code_client) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_supplier') ? 'is-invalid' : '' }}" type="text" name="code_supplier" id="code_supplier" value="{{ old('code_supplier', $entity->code_supplier) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $entity->address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_2') ? 'is-invalid' : '' }}" type="text" name="address_2" id="address_2" value="{{ old('address_2', $entity->address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $entity->zip) }}" required>
                @if($errors->has('zip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $entity->city) }}" required>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $entity->state) }}">
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $entity->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $entity->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $entity->longitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_place') ? 'is-invalid' : '' }}" type="text" name="url_place" id="url_place" value="{{ old('url_place', $entity->url_place) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $entity->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $entity->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('siren') ? 'is-invalid' : '' }}" type="text" name="siren" id="siren" value="{{ old('siren', $entity->siren) }}">
                @if($errors->has('siren'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('siret') ? 'is-invalid' : '' }}" type="text" name="siret" id="siret" value="{{ old('siret', $entity->siret) }}">
                @if($errors->has('siret'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ape') ? 'is-invalid' : '' }}" type="text" name="ape" id="ape" value="{{ old('ape', $entity->ape) }}">
                @if($errors->has('ape'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vatnumber') ? 'is-invalid' : '' }}" type="text" name="vatnumber" id="vatnumber" value="{{ old('vatnumber', $entity->vatnumber) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capital') ? 'is-invalid' : '' }}" type="number" name="capital" id="capital" value="{{ old('capital', $entity->capital) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note_private') ? 'is-invalid' : '' }}" name="note_private" id="note_private">{{ old('note_private', $entity->note_private) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note_public') ? 'is-invalid' : '' }}" name="note_public" id="note_public">{{ old('note_public', $entity->note_public) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $entity->active || old('active', 0) === 1 ? 'checked' : '' }}>
