                    ...
                    <div class="card bg-light shadow-lg p-3 text-center rounded" id="card-corner">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control select2 {{ $errors->has('societe') ? 'is-invalid' : '' }}" name="societe_id" id="societe_id">
                                    @foreach($societes as $id => $societe)
                                        <option value="{{ $id }}"
                                            {{ isset($companyId) && $companyId == $id ? 'selected' : '' }}
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 text-left">
                                <div class="row">
                                    <legend class="col-form-label col-sm-4 pl-4 pt-4">{{ trans('cruds.individual.fields.civility') }}</legend>
                                    <div class="col-sm-8">
                            ...
                            <div class="row">
                                <div class="col-lg-7 align-self-center">
                                    <div class="form-group">
                                        <label>{{ trans('cruds.individual.fields.address') }}</label>
                                        <input class="form-control" id="user_input_autocomplete_address" placeholder="Your address...">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ trans('cruds.individual.fields.address_2') }}</label>
                                ...
                                <div class="card col-lg-5 shadow bg-dark text-center">
                                    <div class="row">
                                        <div class="form-group col-lg-2" readonly>
                                            <label>Number</label>
                                            <input class="form-control" id="street_number" name="street_number" readonly>
                                        </div>
                                        <div class="form-group col-lg-10">
                                            <label>Street</label>
                                            <input class="form-control" id="route" name="street" readonly>
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="form-group col-lg-3">
                                            <label>{{ trans('cruds.individual.fields.zip') }}</label>
                                            <input class="form-control" id="postal_code" name="zip" readonly>
                                        </div>

                                        <div class="form-group col-lg-9">
                                            <label>{{ trans('cruds.individual.fields.city') }}</label>
                                            <input class="form-control" id="locality" name="city" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <label>State</label>
                                            <input class="form-control" id="administrative_area_level_2" name="state" readonly>
                                        </div>

                                        <div class="form-group col-lg-6" id="countrydiv">
                                            <label>Country</label>
                                            <input class="form-control" id="country" name="country" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
