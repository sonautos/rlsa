...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.shippLine.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipp-lines.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('modele') ? 'is-invalid' : '' }}" type="text" name="modele" id="modele" value="{{ old('modele', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loading_place') ? 'is-invalid' : '' }}" type="text" name="loading_place" id="loading_place" value="{{ old('loading_place', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cmr_date') ? 'is-invalid' : '' }}" type="text" name="cmr_date" id="cmr_date" value="{{ old('cmr_date') }}">
