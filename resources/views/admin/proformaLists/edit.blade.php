...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.proformaList.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.proforma-lists.update", [$proformaList->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="ref">{{ trans('cruds.proformaList.fields.ref') }}</label>
                <input class="form-control {{ $errors->has('ref') ? 'is-invalid' : '' }}" type="text" name="ref" id="ref" value="{{ old('ref', $proformaList->ref) }}" required>
                @if($errors->has('ref'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('entity') ? 'is-invalid' : '' }}" name="entity_id" id="entity_id" required>
                    @foreach($entities as $id => $entity)
                        <option value="{{ $id }}" {{ (old('entity_id') ? old('entity_id') : $proformaList->entity->id ?? '') == $id ? 'selected' : '' }}>{{ $entity }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('seller') ? 'is-invalid' : '' }}" name="seller_id" id="seller_id" required>
                    @foreach($sellers as $id => $seller)
                        <option value="{{ $id }}" {{ (old('seller_id') ? old('seller_id') : $proformaList->seller->id ?? '') == $id ? 'selected' : '' }}>{{ $seller }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id" required>
                    @foreach($clients as $id => $client)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $proformaList->client->id ?? '') == $id ? 'selected' : '' }}>{{ $client }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('task') ? 'is-invalid' : '' }}" name="task_id" id="task_id">
                    @foreach($tasks as $id => $task)
                        <option value="{{ $id }}" {{ (old('task_id') ? old('task_id') : $proformaList->task->id ?? '') == $id ? 'selected' : '' }}>{{ $task }}</option>
                    @endforeach
                </select>
                @if($errors->has('task'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_created') ? 'is-invalid' : '' }}" type="text" name="date_created" id="date_created" value="{{ old('date_created', $proformaList->date_created) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_valid') ? 'is-invalid' : '' }}" type="text" name="date_valid" id="date_valid" value="{{ old('date_valid', $proformaList->date_valid) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('author') ? 'is-invalid' : '' }}" name="author_id" id="author_id" required>
                    @foreach($authors as $id => $author)
                        <option value="{{ $id }}" {{ (old('author_id') ? old('author_id') : $proformaList->author->id ?? '') == $id ? 'selected' : '' }}>{{ $author }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('valid') ? 'is-invalid' : '' }}" name="valid_id" id="valid_id">
                    @foreach($valids as $id => $valid)
                        <option value="{{ $id }}" {{ (old('valid_id') ? old('valid_id') : $proformaList->valid->id ?? '') == $id ? 'selected' : '' }}>{{ $valid }}</option>
                    @endforeach
                </select>
                @if($errors->has('valid'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_updated') ? 'is-invalid' : '' }}" name="user_updated_id" id="user_updated_id">
                    @foreach($user_updateds as $id => $user_updated)
                        <option value="{{ $id }}" {{ (old('user_updated_id') ? old('user_updated_id') : $proformaList->user_updated->id ?? '') == $id ? 'selected' : '' }}>{{ $user_updated }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status_id" id="status_id">
                    @foreach($statuses as $id => $status)
                        <option value="{{ $id }}" {{ (old('status_id') ? old('status_id') : $proformaList->status->id ?? '') == $id ? 'selected' : '' }}>{{ $status }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_ht') ? 'is-invalid' : '' }}" type="number" name="total_ht" id="total_ht" value="{{ old('total_ht', $proformaList->total_ht) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tva') ? 'is-invalid' : '' }}" type="number" name="tva" id="tva" value="{{ old('tva', $proformaList->tva) }}" step="0.01">
                @if($errors->has('tva'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_ttc') ? 'is-invalid' : '' }}" type="number" name="total_ttc" id="total_ttc" value="{{ old('total_ttc', $proformaList->total_ttc) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remise') ? 'is-invalid' : '' }}" type="number" name="remise" id="remise" value="{{ old('remise', $proformaList->remise) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remise_percent') ? 'is-invalid' : '' }}" type="number" name="remise_percent" id="remise_percent" value="{{ old('remise_percent', $proformaList->remise_percent) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cond_reglement') ? 'is-invalid' : '' }}" name="cond_reglement_id" id="cond_reglement_id">
                    @foreach($cond_reglements as $id => $cond_reglement)
                        <option value="{{ $id }}" {{ (old('cond_reglement_id') ? old('cond_reglement_id') : $proformaList->cond_reglement->id ?? '') == $id ? 'selected' : '' }}>{{ $cond_reglement }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mode_reglement') ? 'is-invalid' : '' }}" name="mode_reglement_id" id="mode_reglement_id">
                    @foreach($mode_reglements as $id => $mode_reglement)
                        <option value="{{ $id }}" {{ (old('mode_reglement_id') ? old('mode_reglement_id') : $proformaList->mode_reglement->id ?? '') == $id ? 'selected' : '' }}>{{ $mode_reglement }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note_private') ? 'is-invalid' : '' }}" name="note_private" id="note_private">{{ old('note_private', $proformaList->note_private) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note_public') ? 'is-invalid' : '' }}" name="note_public" id="note_public">{{ old('note_public', $proformaList->note_public) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_livraison') ? 'is-invalid' : '' }}" type="text" name="date_livraison" id="date_livraison" value="{{ old('date_livraison', $proformaList->date_livraison) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shipping_method') ? 'is-invalid' : '' }}" name="shipping_method_id" id="shipping_method_id">
                    @foreach($shipping_methods as $id => $shipping_method)
                        <option value="{{ $id }}" {{ (old('shipping_method_id') ? old('shipping_method_id') : $proformaList->shipping_method->id ?? '') == $id ? 'selected' : '' }}>{{ $shipping_method }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('delivery_address') ? 'is-invalid' : '' }}" name="delivery_address_id" id="delivery_address_id">
                    @foreach($delivery_addresses as $id => $delivery_address)
                        <option value="{{ $id }}" {{ (old('delivery_address_id') ? old('delivery_address_id') : $proformaList->delivery_address->id ?? '') == $id ? 'selected' : '' }}>{{ $delivery_address }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('paid') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="paid" id="paid" value="1" {{ $proformaList->paid || old('paid', 0) === 1 ? 'checked' : '' }}>
