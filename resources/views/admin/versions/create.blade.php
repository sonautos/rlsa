...
<div class="container">
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.version.title_singular') }}
        </div>
    
        <div class="card-body">
            <form method="POST" action="{{ route("admin.versions.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="modele_id" id="modele" class="form-control select2 {{ $errors->has('modele') ? 'is-invalid' : '' }}">
                            <option value="" {{ old('modele_id') == $id ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('kw') ? 'is-invalid' : '' }}" type="number" name="kw" id="kw" value="{{ old('kw', '') }}" step="1">
                        @if($errors->has('kw'))
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('ch') ? 'is-invalid' : '' }}" type="number" name="ch" id="ch" value="{{ old('ch', '') }}" step="1">
                        @if($errors->has('ch'))
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('co_2') ? 'is-invalid' : '' }}" type="number" name="co_2" id="co_2" value="{{ old('co_2', '') }}" step="1">
                        @if($errors->has('co_2'))
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control {{ $errors->has('energy') ? 'is-invalid' : '' }}" name="energy" id="energy">
                            ...
                            @foreach(App\Models\Version::ENERGY_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('energy', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        @foreach(App\Models\Version::GEAR_RADIO as $key => $label)
                            <div class="form-check {{ $errors->has('gear') ? 'is-invalid' : '' }}">
                                <input class="form-check-input" type="radio" id="gear_{{ $key }}" name="gear" value="{{ $key }}" {{ old('gear', '') === (string) $key ? 'checked' : '' }}>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control {{ $errors->has('equipment') ? 'is-invalid' : '' }}" name="equipment" id="equipment">{!! old('equipment') !!}</textarea>
