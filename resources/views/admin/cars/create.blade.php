        ...
        <div class="card col-10">
            <div class="card-header">
                ...
                <div class="text-center">
                    <h1><input type="text" name="car_name" id="car_name"></h1>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route("admin.cars.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" id="user_input_autocomplete_address" value="{{ old('country') }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control {{ $errors->has('warehouse') ? 'is-invalid' : '' }}" type="text" name="warehouse" id="warehouse" value="{{ old('warehouse') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" name="qty" id="qty">
                                                <option value="0" {{ old('seller_id') === 0 ? 'selected' : '' }}>0</option>
                                                <option value="1" {{ old('seller_id') == 1 ? 'selected' : '' }}>1</option>
                                            </select>
                                            @if($errors->has('qty'))
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control date {{ $errors->has('dispo') ? 'is-invalid' : '' }}" type="text" name="dispo" id="dispo" value="{{ old('dispo') }}">
                                            @if($errors->has('dispo'))
                            ...
                            <div class="card col">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control {{ $errors->has('frevo') ? 'is-invalid' : '' }}" type="number" name="frevo" id="frevo" value="{{ old('frevo') }}" step="0.01">
                                        @if($errors->has('frevo'))
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control {{ $errors->has('real_frevo') ? 'is-invalid' : '' }}" type="number" name="real_frevo" id="real_frevo" value="{{ old('real_frevo') }}" step="0.01">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control {{ $errors->has('link_frevo') ? 'is-invalid' : '' }}" type="text" name="link_frevo" id="link_frevo" value="{{ old('link_frevo') }}">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control {{ $errors->has('price_ht') ? 'is-invalid' : '' }}" type="number" name="price_ht" id="price_ht" value="{{ old('price_ht') }}" step="0.01">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control {{ $errors->has('price_ttc') ? 'is-invalid' : '' }}" type="number" name="price_ttc" id="price_ttc" value="{{ old('price_ttc') }}" step="0.01">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input class="form-control datetime {{ $errors->has('last_price_update') ? 'is-invalid' : '' }}" type="text" name="last_price_update" id="last_price_update" value="{{ old('last_price_update') }}">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="form-check {{ $errors->has('increasePrice') ? 'is-invalid' : '' }}">
                                            <input type="hidden" name="increasePrice" value="0">
                                            <input class="form-check-input" type="checkbox" name="increasePrice" id="increasePrice" value="1" {{ old('increasePrice', 0) == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="increasePrice">{{ trans('cruds.car.fields.increasePrice') }}</label>
                                        </div>
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select class="form-control select2 {{ $errors->has('make') ? 'is-invalid' : '' }}" name="make_id" id="make" required>
                                        ...
                                        <div class="form-group col-lg-5">
                                            ...
                                            <select name="modele_id" id="modele" class="form-control select2 {{ $errors->has('modele') ? 'is-invalid' : '' }}">
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('motor') ? 'is-invalid' : '' }} " type="text" name="motor" id="motor" value="{{ old('motor') }}" >
                                            @if($errors->has('motor'))
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('ch') ? 'is-invalid' : '' }} required" type="number" name="ch" id="ch" value="{{ old('ch') }}" step="1">
                                            @if($errors->has('ch'))
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('co_2') ? 'is-invalid' : '' }} required" type="number" name="co_2" id="co_2" value="{{ old('co_2') }}" step="1">
                                            @if($errors->has('co_2'))
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('energy') ? 'is-invalid' : '' }} required" type="text" name="energy" id="energy" value="{{ old('energy') }}">
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('gear') ? 'is-invalid' : '' }}" type="text" name="gear" id="gear" value="{{ old('gear') }}">
                                            @if($errors->has('gear'))
                                        ...
                                        <div class="form-group col-lg-5 mx-auto">
                                            ...
                                            <input class="form-control {{ $errors->has('conso') ? 'is-invalid' : '' }}" type="number" name="conso" id="conso" value="{{ old('conso') }}" step="0.01" max="100">
                                            @if($errors->has('conso'))
                                        ...
                                        {{-- <div class="form-group col-lg-5 mx-auto">
                                            <label for="price_new">{{ trans('cruds.car.fields.price_new') }}</label>
                                            <input class="form-control {{ $errors->has('price_new') ? 'is-invalid' : '' }}" type="number" name="price_new" id="prix" value="{{ old('price_new') }}" step="0.01">
                                            @if($errors->has('price_new'))
                                                <span class="text-danger">{{ $errors->first('price_new') }}</span>
                                            @endif
                                            <span class="help-block">{{ trans('cruds.car.fields.price_new_helper') }}</span>
                                ...
                                <div class="card shadow p-3">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input class="form-control {{ $errors->has('idv') ? 'is-invalid' : '' }}" type="text" name="idv" id="idv" value="{{ old('idv') }}">
                                            @if($errors->has('idv'))
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input class="form-control date {{ $errors->has('mec') ? 'is-invalid' : '' }}" type="text" name="mec" id="mec" value="{{ old('mec') }}">
                                            @if($errors->has('mec'))
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input class="form-control {{ $errors->has('kms') ? 'is-invalid' : '' }}" type="number" name="kms" id="kms" value="{{ old('kms') }}" step="1">
                                            @if($errors->has('kms'))
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input class="form-control {{ $errors->has('interior') ? 'is-invalid' : '' }}" type="text" name="interior" id="interior" value="{{ old('interior') }}">
                    ...
                    <div class="card shadow-lg p-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('serie') ? 'is-invalid' : '' }}" name="serie" id="equipment">{!! old('serie') !!}</textarea>
                            @if($errors->has('serie'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('feature') ? 'is-invalid' : '' }}" name="feature" id="feature">{!! old('feature') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('private_note') ? 'is-invalid' : '' }}" type="text" name="private_note" id="private_note">{{ old('private_note') }}</textarea>
                    ...
                    <div class="card shadow-xl p-3">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>{{ trans('cruds.car.fields.country') }}</label>
                                    <input class="form-control" id="user_input_autocomplete_address" placeholder="Your country...">
                                </div>
                                <div class="form-group">
                                    <label for="country">{{ trans('cruds.car.fields.country') }}</label>
                                    <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', '') }}">
                    ...
                    <div class="card shadow-xl p-3 mt-3">
                        ...
                        <div class="card shadow p-3">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3 mx-auto">
                                    <label for="description">{{ trans('cruds.car.fields.description') }}</label>
                                    <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }} required" type="text" name="description" id="description" value="{{ old('description', '') }}" required>
                                    @if($errors->has('description'))
                                        <span class="text-danger">{{ $errors->first('description') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.car.fields.description_helper') }}</span>
                                ...
                                <div class="form-group">
                                    <label for="motor">{{ trans('cruds.car.fields.motor') }}</label>
                                    <input class="form-control {{ $errors->has('motor') ? 'is-invalid' : '' }} required" type="text" name="motor" id="motor" value="{{ old('motor', '') }}" required>
                                    @if($errors->has('motor'))
                                        <span class="text-danger">{{ $errors->first('motor') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.car.fields.motor_helper') }}</span>
                                ...
                                <div class="form-group">
                                    <label for="ch">{{ trans('cruds.car.fields.ch') }}</label>
                                    <input class="form-control {{ $errors->has('ch') ? 'is-invalid' : '' }} required" type="number" name="ch" id="ch" value="{{ old('ch', '') }}" step="1" required>
                                    @if($errors->has('ch'))
                                        <span class="text-danger">{{ $errors->first('ch') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.car.fields.ch_helper') }}</span>
                        ...
                        <div class="card shadow p-3">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    <label for="kms">{{ trans('cruds.car.fields.kms') }}</label>
                                    <input class="form-control {{ $errors->has('kms') ? 'is-invalid' : '' }}" type="number" name="kms" id="kms" value="{{ old('kms', '') }}" step="0.01">
                                    @if($errors->has('kms'))
                                        <span class="text-danger">{{ $errors->first('kms') }}</span>
                                    @endif
                                    <span class="help-block">{{ trans('cruds.car.fields.kms_helper') }}</span>
                        ...
                        <div class="card shadow-lg p-3">
                            ...
                            <div class="form-group">
                                <label for="serie">{{ trans('cruds.car.fields.serie') }}</label>
                                <textarea class="form-control ckeditor {{ $errors->has('serie') ? 'is-invalid' : '' }}" name="serie" id="equipment">{!! old('serie') !!}</textarea>
                                @if($errors->has('serie'))
                                    <span class="text-danger">{{ $errors->first('serie') }}</span>
                                @endif
                                <span class="help-block">{{ trans('cruds.car.fields.serie_helper') }}</span>
                            ...
                            <div class="form-group">
                                <label for="feature">{{ trans('cruds.car.fields.feature') }}</label>
                                <textarea class="form-control ckeditor {{ $errors->has('feature') ? 'is-invalid' : '' }}" name="feature" id="feature">{!! old('feature') !!}</textarea>
                                @if($errors->has('feature'))
                                    <span class="text-danger">{{ $errors->first('feature') }}</span>
                                @endif
                                <span class="help-block">{{ trans('cruds.car.fields.feature_helper') }}</span>
                    ...
                    <div class="card shadow-xl p-3 mt-3">
                        <div class="card shadow-lg p-3">
                            <div class="card-header text-center">
                                <h5>{{ trans('global.Financial-data')}}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                    ...
                                    <div class="form-group col-lg-3">
                                        <div class="form-check {{ $errors->has('impuesto') ? 'is-invalid' : '' }}">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="impuesto" id="impuesto" value="1" {{ old('impuesto', 0) == 1 ? 'checked' : '' }}>
...
<script type="text/javascript">
    ...
    $("#modele").change(function(){
        $.ajax({
            url: "{{ route('api.modeles.get_by_modele') }}?modele_id=" + $(this).val(),
            method: 'GET',
            success: function(data) {
                console.log(data);
    ...
    $("#version").change(function(){
        $.ajax({
            url: "{{ route('api.version.get_by_version') }}?version_id=" + $(this).val(),
            method: 'GET',
