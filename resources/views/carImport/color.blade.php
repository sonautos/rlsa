            ...
            <div class="table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input class="input border bg-light" type="text" name="code" value="{{ $code_color }}" readonly>
                            </td>
                            <td>
                                <select name="make" id="make" class="border bg-light" selected>
                            ...
                            <td><a href="{{'https://www.google.fr/search?q=code+couleur+'.$code_color.'+'.$make->name.''}}" target="_blank"><i class="fab fa-google"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
