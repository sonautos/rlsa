            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="firstname" id="name" value="{{ old('firstname', auth()->user()->firstname) }}" required>
                    ...
                    <div class="form-group">
                        <label class="" for="api_key">{{ trans('cruds.user.fields.api-key') }}</label>
                        <input class="form-control {{ $errors->has('api_key') ? 'is-invalid' : '' }}" type="text" name="api_key" id="name" value="{{ old('api_key', auth()->user()->api_key) }}">
