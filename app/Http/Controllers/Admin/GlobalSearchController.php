...
{
    private $models = [
        'Feature'      => 'cruds.feature.title',
        'Car'          => 'cruds.car.title',
        'Company'      => 'cruds.company.title',
        'Individual'   => 'cruds.individual.title',
        'Entity'       => 'cruds.entity.title',
        'Address'      => 'cruds.address.title',
        'Truck'        => 'cruds.truck.title',
        'OrderLine'    => 'cruds.orderLine.title',
        'ProformaLine' => 'cruds.proformaLine.title',
        'InvoiceLine'  => 'cruds.invoiceLine.title',
    ];
